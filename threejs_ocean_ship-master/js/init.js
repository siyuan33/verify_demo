...
function initAnimate() {
  ...
  if (engineerShip) {
    engineerShip.position.z += derect ? random / 10 : -random / 10;
    engineerShip.position.x += derect ? random / 10 : -random / 10;
    engineerShip.rotation.y += derect ? random / 100 : -random / 100;
    if (engineerShip.position.z > 1) derect = 0;
    if (engineerShip.position.z < -1) derect = 1;
    // if (engineerShip.position.x > 1) engineerShip.position.x = 1;
    // if (engineerShip.position.x < -1) engineerShip.position.x = -1;
  }
  if (thingsShip) {
    thingsShip.position.z += (Math.random() * 2 - 1) / 30;
    thingsShip.position.x += (Math.random() * 2 - 1) / 30;
    if (thingsShip.position.z > 1) thingsShip.position.z = 1;
    if (thingsShip.position.z < -1) thingsShip.position.z = -1;
    if (thingsShip.position.x > 1) thingsShip.position.x = 1;
    if (thingsShip.position.x < -1) thingsShip.position.x = -1;
